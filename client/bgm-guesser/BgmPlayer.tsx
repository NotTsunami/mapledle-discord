/*
  Port of mapledoro's BgmPlayer for the Discord Activity. Only the import paths
  and the accent-ink colour differ from the web version.
  ...
  Inside Discord the mp3 comes through the `/haku` URL mapping like every other
  resource; a mapping that doesn't serve `/api/bgm/...` leaves the player in its
  "could not be loaded" state (DEPLOYMENT.md §6).
*/

import { useRef, useState, type CSSProperties } from "react";
import { bgmTrackUrl } from "../resource";
